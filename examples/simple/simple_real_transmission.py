...
tx_data = chain["recorder_tx"].get_data()
write("output.wav", 22050, tx_data)

# plot data
sns.set_theme()
rx_data = chain["recorder_rx"].get_data()
sns.histplot(data=rx_data,stat="density",bins=50)
plt.show()