...
| Folder | Subject |
|---|---|
| `simple/` | the core chain: symbol generation, mapping, AWGN, SRRC pulse shaping, phase / CFO / IQ-imbalance compensation, probabilistic shaping, channel coding, chain profiling |
