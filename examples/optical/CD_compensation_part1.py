...
from comnumpy.dsp.frontend import Upsampler, Downsampler, SRRC_filter
from comnumpy.channels.optical import Chromatic_Dispersion
from comnumpy.channels.noise import awgn_theo, AWGN
from comnumpy.metrics.detection import compute_ber
...
for k in k_vect:
    ...
    channel = Sequential([
                ...
                Chromatic_Dispersion(z, D=D, lamb=lamb, F_s=F_s),
                noise
                ])
