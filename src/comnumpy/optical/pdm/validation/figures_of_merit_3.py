...
from comnumpy.optical.pdm.compensators import MCMA_to_DD_Czegledi, MCMA_to_DD_Czegledi, DD_Czegledi
...
df.to_csv(f"src\\comnumpy\\optical\\pdm\\validation\\results\\SER_vs_dpTotT_seg{seg}_SNR{SNR}_{ chain["MCMA_to_DD"].name}_S3.csv", index=False)
